...
import com.matyrobbrt.okzoomer.config.ConfigEnums.ZoomModes;
...
public class ManageZoomEvent {
	...
	public static void endTick(Minecraft client) {
		...
		boolean disableZoom = OkZoomerNetwork.getDisableZoom() ||
		...
		boolean isUsingSpyglass = switch (OkZoomerNetwork.getSpyglassDependency()) {
